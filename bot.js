...
const botConfigs = {
  1: {
    ...
    password: process.env.BOT1_PASSWORD || "cyCAzL8u",
  ...
  2: {
    ...
    password: process.env.BOT2_PASSWORD || "CPf1SZo2",
  ...
  3: {
    ...
    password: process.env.BOT3_PASSWORD || "z4Tu7ssw",
  ...
  4: {
    ...
    password: process.env.BOT4_PASSWORD || "qNdGdDy5",
