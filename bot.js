...
const botConfigs = {
  1: {
    ...
    restart: Number(process.env.BOT1_RESTART_MINUTES || 7),
  ...
  2: {
    ...
    restart: Number(process.env.BOT2_RESTART_MINUTES || 10),
  ...
  3: {
    ...
    restart: Number(process.env.BOT3_RESTART_MINUTES || 15),
  ...
  4: {
    ...
    restart: Number(process.env.BOT4_RESTART_MINUTES || 15),
